import { DadIdAttribute, DadIdDDO } from './types';
...
export interface IdentityApi {
   ...
   */
  getDDO({ identity }: { identity: string }): Promise<DadIdDDO>;
   ...
   * @throws NO_IDENTITY
   */
  addAttributes({ attributes }: { attributes: DadIdAttribute[] }): Promise<void>;
