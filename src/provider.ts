import { WindowPostMessageProxy } from '@DAD-Chain/window-post-message-proxy';
...
export function registerProvider({ provider, logMessages }: { provider: DApi; logMessages: boolean }) {
  ...
  checkedRegister('network.getUnboundDad', provider.network.getUnboundDad);
  ...
  checkedRegister('network.getGrantDad', provider.network.getGrantDad);
  ...
  checkedRegister('dadContract.makeChangeStatusOrderPlacedTx', provider.dadContract.makeChangeStatusOrderPlacedTx);
  checkedRegister('dadContract.makeContributeTx', provider.dadContract.makeContributeTx);
  checkedRegister('dadContract.makePlaceADTx', provider.dadContract.makePlaceADTx);
  checkedRegister('dadContract.makePledgeTx', provider.dadContract.makePledgeTx);
  checkedRegister('dadContract.invoke', provider.dadContract.invoke);
}
